            ...
            try:
                blog_to_podcast_agent = Agent(
                    ...
                    instructions=[
                        ...
                        "2. Create a concise summary of the blog content that is NO More than 400 characters long",
                        ...
                        "Ensure the summary is within 400 character limit to avoid ElevenLabs API limits"
                    ],
                    markdown=True, 
                    debug_mode=True,
                )
